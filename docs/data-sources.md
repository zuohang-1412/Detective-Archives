...
- 第 18 卷“工藤俊作／横滨蓝调”仍缺少能明确证明对应关系的一手资料，保持 `SOURCE_CAPTURED` 和待复核说明；正式作品只关联东映确认的《侦探物语》。

执行 `npm run check:content-audit` 会验证样本数量与分层覆盖、当前有效人物/作品/来源对应、纠错批次是否生效、待补证项是否有下一步，以及全量有效代表作品标签是否仍存在同类标点失配。
