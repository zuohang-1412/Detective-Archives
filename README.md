...
首版目录已形成 150 位人物、160 部公开作品、161 条有效正版/馆藏入口和 109 条图鉴推荐直达的数据闭环；已发布人物均有权威来源和代表作品，当前外链巡检与证据复核为 107 条自动健康、51 条人工确认、3 条继续复核、0 条确认失效。AI 视频属于 P2 范围，详见 `docs/PRD-v0.1.md`。
