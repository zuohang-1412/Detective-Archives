...
- 132 位正式目录人物及 120 部可浏览代表作品数据，109 条图鉴记录均已关联正式档案。
...
- 短评/长评、本人编辑删除、剧透折叠、回复、点赞、举报、微信内容安全预检和默认人工待审核流程。
- 内置运营后台：独立管理员登录、数据概览、侦探/来源/代表案件/作品维护、评价审核、举报处理、角色管理、审计日志和链接质量反馈；所有列表按每页最多 50 条读取并完整加载。
...
首版目录已形成 132 位人物、120 部作品和 121 条正版链接的数据闭环，内容仍会持续核验与扩充；AI 视频属于 P2 范围，详见 `docs/PRD-v0.1.md`。
