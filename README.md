...
- 150 位正式目录人物及 146 部可浏览代表作品数据，109 条图鉴记录均已关联正式档案；92 条已提取原始推荐标签全部可进入对应作品、合集或系列的正版渠道。
...
- 内置运营后台：独立管理员登录、产品指标、侦探/来源/代表案件/作品维护、评价审核、版主剧透纠正、举报与申诉处理、角色管理、审计日志和链接质量反馈；所有列表按每页最多 50 条读取并完整加载。
...
首版目录已形成 150 位人物、146 部作品、147 条正版/馆藏链接和 92 条图鉴推荐直达的数据闭环；已发布人物均有权威来源确认，内容仍会持续核验与扩充。AI 视频属于 P2 范围，详见 `docs/PRD-v0.1.md`。
