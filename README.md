...
- 132 位正式目录人物及 123 部可浏览代表作品数据，109 条图鉴记录均已关联正式档案；73 条原始推荐标签中已有 45 条可直接进入对应作品与正版渠道。
...
首版目录已形成 132 位人物、123 部作品、124 条正版链接和 45 条图鉴推荐直达作品的数据闭环，内容仍会持续核验与扩充；AI 视频属于 P2 范围，详见 `docs/PRD-v0.1.md`。
