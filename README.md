...
- 144 位正式目录人物及 137 部可浏览代表作品数据，109 条图鉴记录均已关联正式档案；73 条已提取原始推荐标签全部可进入对应作品、合集或系列的正版渠道。
- 第 1～108 卷名侦探图鉴索引，共 109 条记录（含第 105 卷特装版）。
- 32 位图鉴之外的知名虚构侦探，以及 3 位独立展示的历史断案人物。
...
首版目录已形成 144 位人物、137 部作品、138 条正版/馆藏链接和 73 条图鉴推荐直达的数据闭环；已发布人物均有权威来源确认，内容仍会持续核验与扩充。AI 视频属于 P2 范围，详见 `docs/PRD-v0.1.md`。
